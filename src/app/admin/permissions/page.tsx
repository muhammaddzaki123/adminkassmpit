        ...
        <main className="pt-16 lg:pt-20 p-4 sm:p-6 lg:p-8">
          <div className="max-w-7xl mx-auto space-y-6">
            ...
            <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
              <div>
                <h1 className="mb-2 text-2xl font-bold text-neutral-900 sm:text-3xl">Permissions Management</h1>
                <p className="text-sm text-neutral-600 sm:text-base">Kelola hak akses dan permission sistem</p>
              </div>
              <Button icon={<Plus className="w-4 h-4" />} className="w-full md:w-auto">
                Tambah Permission
              </Button>
            </div>
